           ...
           <div class="col-9">
               ...
               <table class="table">
                   <?php
                    ...
                    $callingInbox = mysqli_query($connect,"select * from mails JOIN accounts ON mails.Sender_id=accounts.id where reciever_id='$loginedUserId' OR sender_id='$loginedUserId' ORDER BY mail_id DESC");
                ...
                ?>
                   <tr>
                       ...
                       <strong>
                       <?php 
                       if($row['status'] == 1 && $row['reciever_id'] == $loginedUserId){
                       ...
                       <?= $row['subject'];?> -</strong> <span class="text-muted"><?= $row ['content'];?></span></a></td>
                       <td>
